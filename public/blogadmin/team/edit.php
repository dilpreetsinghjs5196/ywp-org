                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-8" style="margin-left: 19rem;">
                                ...
                                <div class="form-group col-md-12">
                                  ...
                                  <input type="text" class="form-control" name="user_title" value="<?php echo $row['user_title'];?>">
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description">value="<?php echo $row['description'];?>"</textarea>
                                </div>
