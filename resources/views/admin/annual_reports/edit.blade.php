...
<div class="glass-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0 text-capitalize">Edit Annual Report</h1>
    ...
    <form action="{{ route('admin.annual-reports.update', $report->id) }}" method="POST" enctype="multipart/form-data">
        @csrf @method('PUT')
        <div class="row g-4">
            <div class="col-md-4">
                <div class="text-center mb-4 p-4 border rounded" style="background: rgba(0,0,0,0.02);">
                    ...
                    @else
                         <div style="height: 150px; background: #f1f5f9; border-radius: 15px; display: flex; align-items: center; justify-content: center;" class="mb-3">
                            <i class="fa fa-file-pdf text-muted fa-3x"></i>
                        </div>
                    @endif
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label class="form-label text-muted small">PDF Document Link</label>
