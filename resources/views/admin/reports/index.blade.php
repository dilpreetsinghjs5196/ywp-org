...
<div class="glass-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">Manage Research Papers</h1>
        <a href="{{ route('admin.reports.create') }}" class="btn btn-success" style="border-radius: 12px; padding: 12px 24px;">
                ...
                @foreach($reports as $report)
                    <tr>
                        ...
                        <td>
                            ...
                            @if($report->link)
                                <a href="{{ $report->link }}" target="_blank" class="small text-primary">View Link</a>
                            @endif
                        </td>
                        <td>
                        ...
                        <td class="text-end">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('admin.reports.edit', $report->id) }}" class="btn btn-outline-primary btn-sm" style="border-radius: 8px;">
