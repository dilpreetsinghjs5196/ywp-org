...
<div class="glass-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0 text-capitalize">Edit Policy</h1>
        <a href="{{ route('admin.policies.index') }}" class="btn btn-outline-secondary" style="border-radius: 12px; height: 45px; width: 45px; display: flex; align-items: center; justify-content: center;">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="text-center mb-4 p-4 border rounded" style="background: rgba(0,0,0,0.02);">
                    @if($policy->image)
                        <img src="{{ asset($policy->image) }}" class="img-fluid rounded shadow-sm mb-3" style="max-height: 200px; border-radius: 15px;">
                    @else
                    ...
                    <div class="text-start">
                        ...
                        @else
                            <div class="mt-3 text-muted small">
                                <i class="fa fa-info-circle"></i> No image currently assigned.
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div class="mb-4">
                    <label class="form-label text-muted small">Policy Title</label>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="form-control" rows="5">{{ $policy->description }}</textarea>
                </div>
