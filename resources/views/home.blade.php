                ...
                <ul class="list-unstyled we-believe__list">
                    <a href="{{ url('events') }}">
                     <li class="we-believe__single wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <h3 class="we-believe__title"><a href="{{ url('events') }}">Engage</a></h3>
                    </li>
                    </a>
                    ...
                    <li class="we-believe__single wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <h3 class="we-believe__title"><a href="mailto:peersupport@yourewonderfulproject.org"> Peer Support</a></h3>
                    </li>
                    </a>
                    
                    <a href="{{ url('advisory-board') }}">
                    <li class="we-believe__single wow fadeInUp" data-wow-delay="300ms">
                        <div class="we-believe__icon">
                            <span class="icon-peace-1"></span>
                        </div>
                        <h3 class="we-believe__title"><a href="{{ url('advisory-board') }}">Professionals</a></h3>
                    </li>
                    </a>
                    ...
                    <li class="we-believe__single wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <h3 class="we-believe__title"><a href="{{ url('reports') }}">Research</a></h3>
                    </li>
                    </a>
                </ul>
            </div>
            ...
            <div class="col-xl-6">
                <div class="welcome-one__right">
                    <div class="section-title text-left">
                        ...
                        <h2 class="section-title__title">YWP; is creating a safe space for the youth.</h2>
                    </div>
                    
                    <p class="welcome-one__text-2">We at YWP; believe in providing a safe space to individuals struggling with mental health issues to give expression to their distressing feelings and thoughts without judgment and stigma. As such our work so far has not only included giving people a platform to share their stories but also provide peer counselling in view of curbing growing cases of suicide and self-harm.
</p>
                    <div class="welcome-one__btn-box">
                        <a href="https://www.youthkiawaaz.com/author/ywpconnect/" class="thm-btn welcome-one__btn" target="_blank">Discover More</a>
                        <div class="welcome-one__video-link">
                            <a href="https://www.youtube.com/c/YoureWonderfulProject" class="" target="_blank">
...
<section class="causes-one">
    <div class="container">
        <div class="section-title text-left">
            ...
            <h2 class="section-title__title">Popular Campaigns </h2>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div class="causes-one__carousel owl-theme owl-carousel">
                    ...
                    <div class="causes-one__single">
                        <div class="causes-one__img">
                            <img src="{{ asset('images/campaigns-1-1.jpg') }}" alt="">
                        ...
                        <div class="causes-one__content-box">
                            <div class="causes-one__content">
                                <h3 class="causes-one__title">
                                    <a href="{{ url('campaigns') }}#speak">S.P.E.A.K</a>
                                </h3>
                                <p class="causes-one__text">You're Wonderful Project; launched its pilot program for schools in Delhi NCR, S.P.E.A.K. - School Program For Emotional Acceptance and Knowledge <a href="{{ url('campaigns') }}#speak">...Read More...</a></p>
                            </div>
                        </div>
                    </div>
                    <!--Cause One Single-->
                    <div class="causes-one__single causes-one__single-2">
                        <div class="causes-one__img">
                            <img src="{{ asset('images/campaigns-1-2.jpg') }}" alt="">
                            <div class="causes-one__category">
                                <span>Disorder Dialogues</span>
                            </div>
                        </div>
                        <div class="causes-one__content-box">
                            <div class="causes-one__content">
                                <h3 class="causes-one__title">
                                    <a href="{{ url('campaigns') }}#disorder">Disorder Dialogues</a>
                                </h3>
                                <p class="causes-one__text">Another franchise event that had 4 editions. Appropriately named, this event included a dialogue of sorts between experienced researchers together with<a href="{{ url('campaigns') }}#disorder">...Read More...</a></p>
                            </div>
                        </div>
                    </div>
                    <!--Cause One Single-->
                    <div class="causes-one__single causes-one__single-3">
                        <div class="causes-one__img">
                            <img src="{{ asset('images/campaigns-1-3.jpg') }}" alt="">
                            <div class="causes-one__category">
                                <span>Confessions Unplugged</span>
                            </div>
                        </div>
                        <div class="causes-one__content-box">
                            <div class="causes-one__content">
                                <h3 class="causes-one__title">
                                    <a href="{{ url('campaigns') }}#confessions">Confessions Unplugged</a>
                                </h3>
                                <p class="causes-one__text">Confessions Unplugged was an 8 edition event franchise that provided attendees with an anonymous platform to share their thoughts and feelings and a safe space<a href="{{ url('campaigns') }}#confessions">...Read More...</a></p>
                          </div>
                        </div>
                    </div>
                    <!--Cause One Single-->
                    <div class="causes-one__single">
                        <div class="causes-one__img">
                            <img src="{{ asset('images/campaigns-1-4.jpg') }}" alt="">
                            <div class="causes-one__category">
                                <span>Connect</span>
                            </div>
                        </div>
                        <div class="causes-one__content-box">
                            <div class="causes-one__content">
                                <h3 class="causes-one__title">
                                    <a href="{{ url('campaigns') }}#connect">Connect</a>
                                </h3>
                                <p class="causes-one__text">You're Wonderful Project; launched its pilot program for schools in Delhi NCR, S.P.E.A.K. - School Program For Emotional Acceptance and Knowledge<a href="{{ url('campaigns') }}#connect">...Read More...</a></p>
                            </div>
                        </div>
                    </div>
                    <!--Cause One Single-->
                    <div class="causes-one__single causes-one__single-2">
                        <div class="causes-one__img">
                            <img src="{{ asset('images/campaigns-1-5.jpg') }}" alt="">
                            <div class="causes-one__category">
                                <span>Discover</span>
                            </div>
                        </div>
                        <div class="causes-one__content-box">
                            <div class="causes-one__content">
                                <h3 class="causes-one__title">
                                    <a href="{{ asset('campaigns') }}#discover">Discover</a>
                                </h3>
                                <p class="causes-one__text">You're Wonderful Project; launched its pilot program for schools in Delhi NCR, S.P.E.A.K. - School Program For Emotional Acceptance and Knowledge<a href="{{ asset('campaigns') }}#discover">...Read More...</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6 col-lg-6" >
                ...
                <div class="two-boxes__single wow slideInLeft" data-wow-delay="100ms"
                    ...
                    <div class="two-boxes__single-bg"
                        style="background-image: url({{ asset('images/two-boxes-single-bg-1.jpg') }});">
                    </div>
                    <div class="two-boxes__icon">
                        <span class="icon-heart"></span>
                    </div>
                    <div class="two-boxes__content" style="padding-bottom:5px;">
                        <a href="mailto:peersupport@yourewonderfulproject.org"><h3 class="two-boxes__title">Free Therapy</h3></a>
                             <br/>
                        <a href="mailto:peersupport@yourewonderfulproject.org" class="donate-btn" target="_blank"> <i class="fa fa-heart"></i> Get Support</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6">
                ...
                <div class="two-boxes__single wow slideInRight" data-wow-delay="100ms"
                    data-wow-duration="2500ms">
                    <div class="two-boxes__single-bg"
                        style="background-image: url({{ asset('images/two-boxes-single-bg-2.jpg') }});">
                    </div>
                ...
                <div class="col-xl-6 col-lg-3 col-md-6">
                    <div class="two-section__gallery-single">
                        <div class="two-section__gallery-img-inner">
                            <img src="{{ asset('images/home-gallery/two-section-gallery-img-1.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-3 col-md-6">
                    <div class="two-section__gallery-single">
                        <div class="two-section__gallery-img-inner">
                            <img src="{{ asset('images/home-gallery/two-section-gallery-img-2.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-3 col-md-6">
                    <div class="two-section__gallery-single">
                        <div class="two-section__gallery-img-inner">
                            <img src="{{ asset('images/home-gallery/two-section-gallery-img-3.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-3 col-md-6">
                    <div class="two-section__gallery-single">
                        <div class="two-section__gallery-img-inner">
                            <img src="{{ asset('images/home-gallery/two-section-gallery-img-4.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<section class="fundraishing">
    <div class="fundraishing-bg-box">
        <div class="fundraishing-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
            style="background-image: url({{ asset('images/fundraishing-bg.jpg') }});"></div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="fundraishing__inner">
                    <p class="fundraishing__sub-title">We’re Here to Support You</p>
                    <h2 class="fundraishing__title">Fundraising for <span>mental health awareness</span> and <br> accessability</h2>
                    <div class="fundraishing__btn-box">
                        <a href="https://pledge.yourewonderfulproject.org/" class="thm-btn fundraishing__btn" target="_blank">Start Donating now</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="featured-campaigns">
    <div class="container">
        <br>
        <div class="row">
             <center> <h2 class="section-title__title">Policies</h2></center><br><br>
            <div class="col-xl-12 col-xxl-12">
               <div class="featured-campaigns__single">
                    <div class="featured-campaigns__content">
                        <h3 class="featured-campaigns__title">View &amp; Download</h3>
                    <div class="events__single">
                        <h3 class="events__title"><a href="https://drive.google.com/file/d/1jaaviNQrMLbNfR_hbks21NcAhkhUqwL6/view" target="_blank">Breaks and Sabbaticals|YWP;</a></h3>
                    ...
                    <div class="featured-campaigns__img" style="background-color:#ebd2d2;">
                        <img src="{{ asset('images/gallery/paper/44-449352_checklist-checklist-png.png') }}" alt="" style="height: 470px;">
                    </div>
                </div>
            </div>
        </div>
...
<section class="paq-page">
    <div class="container">
        <div class="row">
          <center> <h2 class="section-title__title">FAQ'S</h2></center><br><br>
            <div class="col-xl-6 col-lg-6">
                <div class="faq-page__single">
                    <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                        <div class="accrodion">
                            <div class="accrodion-title">
                                <h4>1. What is the vision of YWP;?</h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>The vision of You’re Wonderful Project; is to make mental health available and accessible for all.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accrodion">
                            <div class="accrodion-title">
                                <h4>3. How can we reach out to YWP; for peer support?</h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>YWP; online peer support team is available through our Facebook message option, Instagram DM option and via e-mail at helpteam.ywp@gmail.com
If you prefer to reach out anonymously, you can do so using an anonymous account. You can also chat on our website and someone will respond live to your queries or be there to support. In that case, your identity will remain anonymous. In addition, the peer support team at YWP; assures confidentiality of all the information for everyone contacting us for support.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accrodion last-chiled">
                            <div class="accrodion-title">
                                <h4>5. What paid opportunities does YWP; offer? </h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>You’re Wonderful Project; does not offer any paid opportunities currently. However, the organisation reimburses any organisational expenditure incurred by the members in the course of the working of the organisation. Further, the organisation does recognise the work of the members in the form of rewards and incentives.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="faq-page__single">
                    <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-2">
                        <div class="accrodion">
                            <div class="accrodion-title">
                                <h4>2. What does YWP; do? </h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>You’re Wonderful Project; works on raising awareness on mental health, encouraging acceptance of mental health difficulties, promoting prevention and facilitating intervention. We make this happen through a range of online and offline campaigns, events, workshops and training. These initiatives are in addition to the work our dedicated team puts in towards the same ends.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accrodion">
                            <div class="accrodion-title">
                                <h4>4. What kind of events does YWP; conduct? </h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
